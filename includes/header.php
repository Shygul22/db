        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="hidden lg:flex justify-between">
                <div class="flex space-x-7">
                    <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/php files working area/includes' ? '../index.php' : 'index.php'; ?>" 
                       class="flex items-center py-4">
                        <span class="font-semibold text-gray-500 text-lg">User System</span>
                    </a>
                </div>
                    ...
                    <?php if(isset($_SESSION['user_id'])): ?>
                        <div class="relative group">
                            ...
                            <div class="absolute hidden group-hover:block w-48 bg-white shadow-lg mt-1 rounded-lg">
                                <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/php files working area/includes' ? 'index.php' : 'includes/index.php'; ?>" 
                                   class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Task Dashboard</a>
                            </div>
                        </div>
                        <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/php files working area/includes' ? '../profile.php' : 'profile.php'; ?>" 
                        ...
                        <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/php files working area/includes' ? '../logout.php' : 'logout.php'; ?>" 
                           class="py-2 px-4 bg-red-500 text-white rounded hover:bg-red-600">Logout</a>
                    <?php else: ?>
                        <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/php files working area/includes' ? '../login.php' : 'login.php'; ?>" 
                           class="py-2 px-4 text-gray-500 hover:text-gray-900">Login</a>
                        <a href="<?php echo dirname($_SERVER['PHP_SELF']) == '/php files working area/includes' ? '../register.php' : 'register.php'; ?>" 
